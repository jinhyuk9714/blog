// File: src/test/java/com/portfolio/blog/service/PostServiceTest.java
...
class PostServiceTest {
    ...
    void create_renders_md_and_slug() {
        var saved = posts.createOrUpdate(make("Hello World", "# Title"), Set.of("Spring","REST"), true);
    ...
    void slug_unique() {
        posts.createOrUpdate(make("Hello World", "a"), Set.of(), true);
        var s2 = posts.createOrUpdate(make("Hello World", "b"), Set.of(), true);
        var s3 = posts.createOrUpdate(make("Hello World", "c"), Set.of(), true);
    ...
    void list_published() {
        posts.createOrUpdate(make("Spring Tip", "a"), Set.of(), true);
        posts.createOrUpdate(make("Hidden", "a"), Set.of(), false);
        var page = posts.listPublished("spring", PageRequest.of(0, 10));
